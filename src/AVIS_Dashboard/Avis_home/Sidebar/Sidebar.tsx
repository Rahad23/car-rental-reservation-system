  ...
  return (
    <div>
      <Card
        className={
          darkLight__
            ? "lg:w-[250px] w-full lg:h-screen h- rounded-none lg:border-[1px] lg:border-[#ddd] border-none pt-0 bg-gray-950"
            : "lg:w-[250px] w-full lg:h-screen h- rounded-none lg:border-[1px] lg:border-[#ddd] border-none pt-0 "
        }
      >
